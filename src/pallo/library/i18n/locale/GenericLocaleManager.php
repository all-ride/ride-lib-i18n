...
use pallo\library\i18n\exception\LocaleNotFoundException;
...
class GenericLocaleManager implements LocaleManager {
     ...
     * @var pallo\library\i18n\locale\io\LocaleIO
     */
    protected $io;

    /**
     * Negotiator to determine the current locale
     * @var pallo\library\i18n\locale\negotiator\Negotiator
     */
    protected $negotiator;

    /**
     * Constructs a new generic locale manager
     * @param pallo\library\i18n\locale\io\LocaleIO $io Locale input/output
     * implementation
     * @param pallo\library\i18n\locale\negotiator\Negotiator $negotiator
     * Negotiator to determine the current locale
     * @return null
     */
