...
class I18n {
     ...
     * @var pallo\library\i18n\locale\LocaleManager
     */
    protected $localeManager;

    /**
     * The manager of the translators
     * @var pallo\library\i18n\translator\TranslatorManager
     */
    protected $translatorManager;

    /**
     * Constructs a new internationalization facade
     * @param pallo\library\i18n\locale\LocaleManager $localeManager Manager
     * of the locales
     * @param pallo\library\i18n\translator\TranslatorManager
     ...
     * @throws pallo\library\i18n\exception\LocaleNotFoundException if the
     * locale with the specified code could not be found
     * @throws pallo\library\i18n\exception\I18nException when $code is not
     ...
     * @param null|string|pallo\library\i18n\locale\Locale $locale locale code,
     * a Locale instance or if not specified the current locale is assumed
     * @return pallo\library\i18n\translator\Translator
     * @throws pallo\library\i18n\exception\I18nException when the provided
